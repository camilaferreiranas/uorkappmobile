  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        ...
        <Text style={styles.ratingLabel}>{rating > 0 ? ratingLabels[rating - 1] : 'Selecione uma nota'}</Text>
        ...
        <View style={styles.banner}>
          ...
          <Text style={styles.bannerText}>
            Sua avaliação ajuda profissionais a crescer e garante mais confiança no marketplace.
          </Text>
        </View>

        <TouchableOpacity style={[styles.submitButton, rating === 0 && styles.submitButtonDisabled]} disabled={rating === 0}>
          <Text style={[styles.submitButtonText, rating === 0 && styles.submitButtonTextDisabled]}>Enviar avaliação</Text>
        </TouchableOpacity>
      </ScrollView>
    </SafeAreaView>
  );
