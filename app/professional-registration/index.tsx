        ...
        {etapa === 1 ? (
          <>
            <View style={styles.introCard}>
              <MaterialIcons name="work-outline" size={24} color={Colors.primary} />
                  ...
                  return (
                    ...
                    >
                      <MaterialIcons
                        ...
                        size={20}
                        color={selecionada ? Colors.white : Colors.primary}
                      />
                      <Text
                        style={[
...
const styles = StyleSheet.create({
  ...
  headerSubtitle: { color: Colors.primaryLight, fontSize: 12, marginTop: 3 },
  ...
  stepNumber: { color: Colors.textSecondary, fontSize: 13, fontWeight: "700" },
  stepNumberActive: { color: Colors.white, fontSize: 13, fontWeight: "800" },
  stepLabel: { color: Colors.textSecondary, fontSize: 11, fontWeight: "700", marginTop: 5 },
  stepLabelActive: { color: Colors.primary, fontSize: 11, fontWeight: "700", marginTop: 5 },
  stepLine: {
    width: 70,
    height: 3,
    borderRadius: 2,
  ...
  introText: { flex: 1, color: Colors.textSecondary, fontSize: 13, lineHeight: 19 },
  label: { color: Colors.ink, fontSize: 15, fontWeight: "700" },
  helperText: { color: Colors.textSecondary, fontSize: 12, marginTop: 4, marginBottom: 12 },
  feedbackContainer: {
    minHeight: 120,
    alignItems: "center",
    justifyContent: "center",
  ...
  feedbackText: { color: Colors.textSecondary, fontSize: 13 },
  cepLoading: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "center",
  ...
  errorText: { color: Colors.error, fontSize: 13, lineHeight: 18, textAlign: "center" },
  addressError: {
    color: Colors.error,
    fontSize: 13,
    lineHeight: 18,
  ...
  categoryButtonText: { flex: 1, color: Colors.textSecondary, fontSize: 13, fontWeight: "700" },
  categoryButtonTextSelected: { color: Colors.white },
  descriptionHeader: {
    flexDirection: "row",
    alignItems: "center",
  ...
  characterCount: { color: Colors.textSecondary, fontSize: 11 },
  descriptionInput: {
    minHeight: 138,
    borderRadius: 16,
    borderWidth: 1,
